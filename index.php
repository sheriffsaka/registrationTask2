					...
					<div class="container">
											...
											<fieldset>
												...
												<div>
													...
													<input type="text" name="username" placeholder="Enter Username" required value="<?php if($error) echo $name; ?>" class="form-control" /><p>
													<span><?php if (isset($uname_error)) echo $uname_error; ?></span>
												</div>
												<div>
													<label for="name">Email</label>
													<input type="text" name="email" placeholder="Email" required value="<?php if($error) echo $email; ?>" class="form-control" /><p>
												...
												<div>
													...
													<input type="password" name="cpassword" placeholder="Confirm Password" required class="form-control" /><p>
